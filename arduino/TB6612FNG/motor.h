...
public:
   ...
   *  La commande peut varier de -255 à 255, cette valeur représente la fraction de la tension
   *  d'alimentation du TB6612NG qui est appliquée au moteur.
   *  0 correspond à une tension nulle et 255 à la tension d'alimentation.
   *  Le signe de la commande définit le sens de rotation du moteur.
   *  Paramètre :
   *    vitesse : commande à appliquer au moteur, peut varier de -255 à 255. */
  void changeVitesse(int vitesse);
  
  /** Renvoie la valeur de la commande actuellement appliquée au moteur 
   *  Retour : valeur de la commande, entre -255 et 255 */
  float vitesseRead();
};
